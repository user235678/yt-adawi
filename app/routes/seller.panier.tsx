...
import { CreditCard, Loader2, X, CheckCircle, Calendar } from "lucide-react";
...
export async function loader({ request }: LoaderFunctionArgs) {
    try {
        console.log("🔍 Début du loader panier vendeur");
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="space-y-3">
                                    ...
                                    <button
                                        ...
                                        className={`w-full bg-gradient-to-r from-blue-500 to-blue-600 text-white font-medium py-4 px-6 text-base rounded-full hover:from-blue-600 hover:to-blue-700 transition-all duration-300 tracking-wider transform hover:scale-[1.02] active:scale-[0.98] shadow-lg hover:shadow-xl ${isClearing ? 'opacity-50 cursor-not-allowed' : ''}`}
                                    >
                                        <span className="flex items-center justify-center">
